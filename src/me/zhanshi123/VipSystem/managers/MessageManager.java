...
public class MessageManager {
	...
	{
		File f=new File(Main.getInstance().getDataFolder().getAbsolutePath()+"/messages/"+Main.getConfigManager().getLanguage()+".yml");
	...
	public static String prefix,QueriedBySelfPermanent,QueriedByAdminPermanent,permanent,Showed,CodeCreated,NewUpdate,LatestVersion,UpdateFailed,FailedToGetOnlinePlayers,LoadingComplete,DatabaseInitError,Loading,StartDetecting,gCacheSaved,CodeExportFailed,CodeExport,ThreadCreated,YouAlreadyHaveVip,CodeActivated,CodeNotFound,QueriedBySelf,ConsoleForbid,YouHaveNoVip,CacheSaved,PlayerNotFound,AlreadyHaveVip,HaveNoVip,VipGave,VipRemoved,QueriedByAdmin;
